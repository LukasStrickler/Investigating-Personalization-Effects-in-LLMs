...
NOTE: wildchat_personas.jsonl and wildchat_conversations.jsonl are
regenerated locally by the workflow below and gitignored — only the CSVs
are committed in this folder. The committed copy of wildchat_personas.jsonl
lives at experiments/behavioral_audit/wildchat_personas.jsonl.
...
wildchat_personas.jsonl                FINAL: personas dataset used downstream
                                       (regenerated locally, gitignored; committed copy:
                                       experiments/behavioral_audit/wildchat_personas.jsonl)

...
WHAT THIS PRODUCES
    ...
    Movie/Hobby come from gender.csv; Name/Artist come from region.csv — so the
    Name/Artist curves also probe whether region-derived text leaks Gender.

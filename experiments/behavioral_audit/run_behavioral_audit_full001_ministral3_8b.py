...
Run inside tmux so the process survives lid-close / screen-off:
    ...
    tmux new -s audit-ministral
    cd <repo-root>
    python experiments/behavioral_audit/run_behavioral_audit_full001_ministral3_8b.py
    # detach with Ctrl-B D, reattach later with: tmux attach -t audit-ministral
"""
...
RUN_TAG = "full001-ministral3-8b"

EXPERIMENT_MODELS = ["ministral-3-8b_modal"]

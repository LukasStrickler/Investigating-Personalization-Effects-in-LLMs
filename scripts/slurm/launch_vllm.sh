#!/usr/bin/env bash
# Shared vLLM launcher. Invoked by scripts/slurm/<cluster>.sbatch via `exec scripts/slurm/launch_vllm.sh`.
#
...
#   SIF=<path>  (Helix)  IMAGE=...  (from scripts/slurm/vllm_constants.sh when unset)
set -euo pipefail

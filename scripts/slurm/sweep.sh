...
#   bash scripts/slurm/sweep.sh <cluster> <manifest> [extra k=v sbatch exports...]
#   bash scripts/slurm/sweep.sh bwunicluster scripts/slurm/models.example.txt
#   bash scripts/slurm/sweep.sh helix scripts/slurm/models.example.txt SIF=$PWD/vllm-openai.sif
#
...
case "$CLUSTER" in
  bwunicluster) SBATCH_FILE="scripts/slurm/bwunicluster.sbatch" ;;
  helix)        SBATCH_FILE="scripts/slurm/helix.sbatch" ;;
